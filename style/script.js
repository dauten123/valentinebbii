...
const message = "Anh cảm ơn em đã đến bên anh, thật sự hạnh phúc và vui khii có em ở bên cạnh.Anh chúc bé Valetine vui vẻ, lun cười, xinh đẹp cố gắng đỗ NV1.Ta cùng nhau đón năm mới nhaaa bbii. Yêuu emm thật nhìuuuu.";
...
function init3D() {
    ...
    const imagePaths = Array.from({ length: 20 }, (_, i) => `style/img/Anh (${i + 1}).jpg`);
